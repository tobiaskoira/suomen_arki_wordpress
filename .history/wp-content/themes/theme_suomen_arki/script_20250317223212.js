...
document.addEventListener("DOMContentLoaded", function () {
    ...
    closeBtn.addEventListener("click", function () {
        console.log("Close button clicked!");
        console.log("Before remove:", document.body.classList);
        nav.classL    document.body.style.overflow = "";
        document.documentElement.style.overflow = "";ist.remove("active");
        document.body.style.overflow = "visible";
        console.log("Body overflow set to:", document.body.style.overflow);
        console.log("After remove:", document.body.classList);
    });
