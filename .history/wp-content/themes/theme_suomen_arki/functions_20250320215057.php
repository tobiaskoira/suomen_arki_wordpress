...
function enqueue_scroll_to_top_script() {
    wp_enqueue_script("scroll-to-top", get_template_directory_uri() . "/script.js", array(), time(), true);
}
...
// This code force translation loading at the correct time 
add_action('init', function () {
    load_plugin_textdomain('woocommerce', false, plugin_basename(WP_PLUGIN_DIR . '/woocommerce/languages/'));
    load_plugin_textdomain('complianz-gdpr', false, plugin_basename(WP_PLUGIN_DIR . '/complianz-gdpr/languages/'));
});
add_action('init', function () {
    if (function_exists('load_plugin_textdomain')) {
        load_plugin_textdomain('gtranslate', false, dirname(plugin_basename(__FILE__)) . '/languages/');
    }
});
?> 