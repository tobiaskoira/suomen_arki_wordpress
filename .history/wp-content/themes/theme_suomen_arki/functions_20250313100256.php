...
function enqueue_scroll_to_top_script() {
    wp_enqueue_script("scroll-to-top", get_template_directory_uri() . "/js/script.js", array(), null, true);
}
...
add_action( 'woocommerce_single_product_summary', 'custom_move_product_tabs', 6 );
...
function enable_custom_fileds(){
    add_post_type_support('page', 'custom-fileds')
}
