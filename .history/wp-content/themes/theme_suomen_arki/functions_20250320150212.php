...
add_action('init', function () {
    load_plugin_textdomain('woocommerce', false, WP_PLUGIN_DIR . '/woocommerce/languages/');
    load_plugin_textdomain('complianz-gdpr', false, WP_PLUGIN_DIR . '/complianz-gdpr/languages/');
});
