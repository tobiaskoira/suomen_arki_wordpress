...
document.addEventListener("DOMContentLoaded", function () {
    ...
    menuItems.forEach(function (menuItem) {
        menuItem.addEventListener("click", function (event) {
            ...
            if (subMenu) {
                ...
                let isOpen = parentLi.classList.contains("active");

                // Close all other submenus
                document.querySelectorAll("#top-navi ul.menu li.active").forEach(function (li) {
                    li.classList.remove("active");
                    li.querySelector(".sub-menu").style.maxHeight = null; // Reset height
                });

                // Toggle current submenu
                if (!isOpen) {
                    parentLi.classList.add("active");
                    subMenu.style.maxHeight = subMenu.scrollHeight + "px"; // Smooth open
                } else {
                    parentLi.classList.remove("active");
                    subMenu.style.maxHeight = null; // Smooth close
                }
            }
        });
    });
    ...
    document.addEventListener("click", function (event) {
        if (!event.target.closest("#top-navi")) {
            document.querySelectorAll("#top-navi ul.menu li.active").forEach(function (li) {
                li.classList.remove("active");
