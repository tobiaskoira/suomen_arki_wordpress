...
//     console.log("Mobile menu:", nav);
//     console.log("Close button inside menu:", closeBtn);
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Initialize Select2 on the MEC dropdowns
    setTimeout(function () {
        if (jQuery("#mec_sf_month_126").length) {
            jQuery("#mec_sf_month_126").select2();
        }
        if (jQuery("#mec_sf_year_126").length) {
            jQuery("#mec_sf_year_126").select2();
        }
    }, 1000); // Delay to allow MEC to load
});
